  ...
  return (
   ...
   <Router>
    <Routes>
      ...
      <Route path='/profile' element={<UserProfile imageFeed={imageFeed} getItem={getItem} favourites={favourites} removeFavourite={removeFavourite} setImageFeed={setImageFeed} handleUpload={handleUpload}/> } />
    </Routes>
  </Router>
